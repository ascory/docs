...
```
## Delete webhook(CLOSED API)
```php
<?php
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, "https://api.ascory.com/v1/webhook/delete");
curl_setopt($ch, CURLOPT_HTTPHEADER, [
        "accept: application/json"
]);
curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
...
```
## All webhooks(CLOSED API)
```php
<?php
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, "https://api.ascory.com/v1/webhook/all");
curl_setopt($ch, CURLOPT_HTTPHEADER, [
        "accept: application/json"
]);
curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
...
```json
{
    ...
    "data": [
        {
            "id": 1,
            "url": "https://ananaswebhookshop.com/ascoryWebhookListener",
            "data": {
                "id": 1,
                "item": 1,
                "amount": 0.6,
